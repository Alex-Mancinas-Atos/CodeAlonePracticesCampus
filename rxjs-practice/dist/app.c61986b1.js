...
var rxjs_1 = require("rxjs"); // import { Observable} from "rxjs";
...
var observable1 = rxjs_1.Observable.create(function (data) {
  var i = 1;
  setInterval(function () {
    data.next(i++);
  }, 1000);
});
var observable2 = new rxjs_1.Subject();
setInterval(function () {
  observable2.next('Hey!');
}, 3000);
var newObs = observable1.skipUntil(observable2);
newObs.subscribe(function (x) {
  return addItem(x);
});
