...
var LoteryChannel$ = new _rxjs.Observable(function (suscriber) {
  var loteryNumber = [12, 11, 48, 38];
  loteryNumber.map(function (n) {
    return suscriber.next(n);
  });
});
var tv1 = LoteryChannel$.subscribe(function (value) {
  return console.log("tv1 ".concat(value));
});
setTimeout(function () {
  var tv2 = LoteryChannel$.subscribe(function (value) {
    console.log("tv2 ".concat(value));
  });
}, 5000);
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/rxjs-practice.e31bb0bc.js.map